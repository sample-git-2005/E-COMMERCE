  ...
  const handlePayment = async () => {
    try {
      ...
      var options = {
        ...
        prefill: {
          name: userAddress?.fullName || "User Name",
          email: user.email || "user@example.com",
          contact: userAddress?.phoneNumber || "9000090000",
        },
        notes: {
          address: userAddress?.address || "User Address",
        },
        theme: {
          color: "#3399cc",
        },
